...
glm::mat4 CameraComponent::getProjectionMatrix(float framebufferAspectRatio) const
{
...
glm::mat4 CameraComponent::getViewMatrix(const Transform& transform) const
{
...
glm::mat4 CameraComponent::getCameraMatrix(const Transform& transform, float framebufferAspectRatio) const
{
