...
Texture TextureManager::LoadTexture(const char* filePath, const char* referenceName, bool requiresAlphaChannel)
{
...
Texture TextureManager::GetTexture(const char* referenceName)
{
